...
2. "sentinel": A comma separated list of hostname:port pairs. The list size should be >= 2. The first item is the primary node url and the rest are the sentinels.
