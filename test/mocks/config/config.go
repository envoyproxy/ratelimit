...
// Source: github.com/irlapp/rate-limiter/src/config (interfaces: RateLimitConfig,RateLimitConfigLoader)
...
import (
	...
	config "github.com/irlapp/rate-limiter/src/config"
	stats "github.com/irlapp/rate-limiter/src/stats"
)
