...
func (m *MockRateLimitConfigLoader) Load(arg0 []config.RateLimitConfigToLoad, arg1 stats.Manager, arg2 bool, arg3 *config.DescriptorKeyConfig) config.RateLimitConfig {
	m.ctrl.T.Helper()
...
func (mr *MockRateLimitConfigLoaderMockRecorder) Load(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Load", reflect.TypeOf((*MockRateLimitConfigLoader)(nil).Load), arg0, arg1, arg2, arg3)
}
