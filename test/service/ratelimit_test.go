...
import (
	...
	mock_config "github.com/replicon/ratelimit/test/mocks/config"
	mock_limiter "github.com/replicon/ratelimit/test/mocks/limiter"
	mock_loader "github.com/replicon/ratelimit/test/mocks/runtime/loader"
	mock_snapshot "github.com/replicon/ratelimit/test/mocks/runtime/snapshot"
...
func (this *rateLimitServiceTestSuite) setupBasicService(shadowMode bool) ratelimit.RateLimitServiceServer {
	...
	return ratelimit.NewService(this.runtime, this.cache, this.configLoader, this.statStore, shadowMode, true)
}
