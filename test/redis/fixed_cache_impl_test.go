...
import (
	...
	mock_redis "github.com/zackzhangverkada/ratelimit/test/mocks/redis"
...
func TestOverLimitWithLocalCacheShadowRule(t *testing.T) {
	...
	limits := []*config.RateLimit{
		config.NewRateLimit(15, pb.RateLimitResponse_RateLimit_HOUR, sm.NewStats("key4_value4"), false, true, "", nil),
	}
